...
from prompts.medical_prompts import get_payoff_prompt as medical_payoff
from prompts.court_prompts import get_payoff_prompt as court_payoff
from prompts.persona_prompts import get_payoff_prompt as persona_payoff
from prompts.medical_prompts import get_action_predict_prompt as medical_action
from prompts.court_prompts import get_action_predict_prompt as court_action
from prompts.persona_prompts import get_action_predict_prompt as persona_action
from prompts.medical_prompts import get_evaluate_speech_prompt as medical_eval
from prompts.court_prompts import get_evaluate_speech_prompt as court_eval
from prompts.persona_prompts import get_evaluate_speech_prompt as persona_eval
...
class InteractiveGameEngine:
    """Interactive Simulation Engine - Ablation Experiment: Remove Belief Update Mechanism"""
        ...
        try:
            ...
            for participant in self._participants:
                try:
                    ...
                    response, consumption = await participant.generate_response(
                        self._scenario_type, context, formatted_history
                    )
                    ...
                    # Ablation: Remove belief update mechanism
