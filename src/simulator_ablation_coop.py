...
class InteractiveGameEngine:
    """Interactive Simulation Engine - Ablation Experiment: Fixed Collaboration Type to Cooperation"""
            ...
            for participant in self._participants:
                try:
                    ...
                    prompt = self._build_prompt_ablation(
                        ...
                        context=context,
                        forced_strategy="cooperation" if self._scenario_type == ScenarioType.COURT_DEBATE else "cooperation",
                    )
